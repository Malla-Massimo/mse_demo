...
JDI_FILE := C:/master/EmbHard/mse_demo/quartus_project/mse_demo.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := C:/master/EmbHard/mse_demo/quartus_project/base_system.sopcinfo
...
# Design Name 
# setting SOPC_NAME is base_system
SOPC_NAME := base_system
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x10010d8
SOPC_SYSID_FLAG += --sidp=0x10010d8
ELF_PATCH_FLAG  += --sidp 0x10010d8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1764787345
SOPC_SYSID_FLAG += --timestamp=1764787345
ELF_PATCH_FLAG  += --timestamp 1764787345
